...
class SquadsControllerTest < ActionController::TestCase
  ...
  test "should create squad" do
    assert_difference('Squad.count') do
      post :create, squad: { name: @squad.name, time: @squad.time, tournament_id: @squad.tournament_id, user_id: @squad.user_id }
    end
  ...
  test "should update squad" do
    patch :update, id: @squad, squad: { name: @squad.name, time: @squad.time, tournament_id: @squad.tournament_id, user_id: @squad.user_id }
    assert_redirected_to squad_path(assigns(:squad))
  end
